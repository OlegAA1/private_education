...
class Networks:
    ...
    Fantom = Network(
        ...
        api=API(
            key=config.FANTOM_API_KEY, url='https://api.ftmscan.com/api',
    ...
    Celo = Network(
        ...
        api=API(
            key=config.CELO_API_KEY, url='https://api.celoscan.io/api', docs='https://docs.celo.org/')
    )
    ...
    HECO = Network(
        ...
        api=API(
            key=config.HECO_API_KEY, url='https://api.hecoinfo.com/api', docs='https://docs.hecochain.com/')
    )
